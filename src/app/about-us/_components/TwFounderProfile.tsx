...
export default function TwFounderProfile() {
  return (
        ...
        <div className="mx-auto grid max-w-2xl grid-cols-1 items-start gap-x-8 gap-y-16 sm:gap-y-24 lg:mx-0 lg:max-w-none lg:grid-cols-2">
          <div className="lg:pr-4">
            <div className="relative overflow-hidden rounded-3xl bg-gray-900 px-6 pt-64 pb-9 shadow-2xl sm:px-12 lg:max-w-lg lg:px-8 lg:pb-8 xl:px-10 xl:pb-10">
              <Image
                alt="James Blake, Founder of VisualFlow"
              ...
              >
                <div
                  ...
                  className="aspect-1097/845 w-274.25 bg-linear-to-tr from-[#4e4d4e] to-[#6861eb] opacity-20"
                />
              </div>
              <figure className="relative isolate">
                ...
                <div className="h-25 sm:h-65 lg:h-16 w-auto"></div>
                <blockquote className="mt-6 text-xl/8 font-semibold text-white">
                  <p>
                    &quot;Share knowledge, be authentic, be human, be curious&quot;.
                  </p>
                </blockquote>
                <figcaption className="mt-6 font-open-sans text-sm/6 text-gray-300">
                  <strong className="font-semibold text-white">James Blake,</strong> Founder of VisualFlow
                </figcaption>
              </figure>
            </div>
          </div>
          <div>
            <div className="font-open-sans text-base/7 text-sky-900 lg:max-w-lg">
              <h2 className="mt-2 text-3xl font-nexa-book font-semibold tracking-tight text-pretty text-sky-800 sm:text-5xl">
                Founder&apos;s profile
              </h2>
